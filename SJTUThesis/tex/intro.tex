...
\section{Research Background}
    ...
    to experiment with STEM education, including coding. \todo{cite}
    In America, there are discussions on why coding should be a mandatory class in high school.
    \cite{tim_bajrin_why_2014}

    One part of programming education is mastering one programming language, like Python \todo{cite}.
