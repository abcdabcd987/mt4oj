...
\section{Machine Teaching}
    ...
    the number of which can be hundreds of times more than the number of machine learning experts
    \cite{Simard2017}.

    \subsection{Who teaches whom}

        Machine teaching applications can look quite different depending who teaches whom.

        \subsubsection{Human teacher teaches machine learner}
        ...
        \subsubsection{Machine teacher teaches machine learner}
            ...
            \begin{align*}
                ...
                \textrm{s.t.} & \hat{\theta} = A(D+\delta)
            \end{align*}

        \subsubsection{Machine teacher teaches human learner}
